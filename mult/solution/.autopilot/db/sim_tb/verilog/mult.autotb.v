...
`define AUTOTB_DUT      mult
`define AUTOTB_DUT_INST AESL_inst_mult
`define AUTOTB_TOP      apatb_mult_top
`define AUTOTB_LAT_RESULT_FILE "mult.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "mult.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_mult_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_a 1
`define AESL_DEPTH_b 1
`define AUTOTB_TVIN_a  "./c.mult.autotvin_a.dat"
`define AUTOTB_TVIN_b  "./c.mult.autotvin_b.dat"
`define AUTOTB_TVIN_a_out_wrapc  "./rtl.mult.autotvin_a.dat"
`define AUTOTB_TVIN_b_out_wrapc  "./rtl.mult.autotvin_b.dat"
`define AUTOTB_TVOUT_ap_return  "./c.mult.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.mult.autotvout_ap_return.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.mult.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.mult.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.mult.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.mult.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.mult.autotvout_ap_return.dat with impl_rtl.mult.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
